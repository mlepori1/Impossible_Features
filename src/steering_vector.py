...
DIFF_FEATURES = ["improbable", "impossible", "inconceivable"]
...
if __name__ == "__main__":
    ...
    layer=12
    steering_vectors = pkl.load(open(f"./results/linear_features/{args.model}/diff_vectors.pkl", "rb"))
    print(steering_vectors)

    SENTENCE_FEATURES = ["improbable", "impossible", "inconceivable"]

    for feature in SENTENCE_FEATURES:
        for multiplier in [0, 1, 3, 5]:
